import{_ as r}from"./chunks/ArticleMetadata.8f180298.js";import{_ as i,A as b,o as p,c as u,k as a,a as d,E as h,w as m,O as o,b as y,e as g}from"./chunks/framework.4879a649.js";import"./chunks/md5.3e7612d8.js";const G=JSON.parse('{"title":"如何使用 Github+Actions 实现 Hexo 博客自动化部署","description":"","frontmatter":{"title":"如何使用 Github+Actions 实现 Hexo 博客自动化部署","date":"2021-05-24 20:27","categories":["note"],"tags":["Actions","github","CI/CD"]},"headers":[],"relativePath":"note/2021/05/24/How_to_automate_the_deployment_of_the_Hexo_blog_using_Github-Actions.md","filePath":"note/2021/05/24/How_to_automate_the_deployment_of_the_Hexo_blog_using_Github-Actions.md","lastUpdated":1711185179000}'),_={name:"note/2021/05/24/How_to_automate_the_deployment_of_the_Hexo_blog_using_Github-Actions.md"};function f(n,s,k,q,w,H){const t=r,c=b("ClientOnly");return p(),u("div",null,[s[0]||(s[0]=a("h1",{id:"如何使用-github-actions-为自己的个人博客实现-ci-cd-的自动化部署",tabindex:"-1"},[d("如何使用 Github+Actions 为自己的个人博客实现 CI/CD 的自动化部署 "),a("a",{class:"header-anchor",href:"#如何使用-github-actions-为自己的个人博客实现-ci-cd-的自动化部署","aria-label":'Permalink to "如何使用 Github+Actions 为自己的个人博客实现 CI/CD 的自动化部署"'},"​")],-1)),h(c,null,{default:m(()=>{var e,l;return[(((e=n.$frontmatter)==null?void 0:e.aside)??!0)&&(((l=n.$frontmatter)==null?void 0:l.showArticleMetadata)??!0)?(p(),y(t,{key:0,article:n.$frontmatter},null,8,["article"])):g("",!0)]}),_:1}),s[1]||(s[1]=o('<p>之前为了更好的学习前端技术，也就在 Github 仓库上来建立了自己的个人博客。在使用了一段时间之后，我也发现了一种新的玩法，可以使用 Github 的 Actions 来对自己的博客站点内容进行持续集成和持续部署，也就是说，根据本篇的内容，你只需要 3 个 git 命令就能实现 Hexo 博客的部署，强烈建议小伙伴们积极动手试一试，在提升上线效率上极有帮助。</p><h2 id="准备工作" tabindex="-1">准备工作 <a class="header-anchor" href="#准备工作" aria-label="Permalink to &quot;准备工作&quot;">​</a></h2><h4 id="什么是-devops-和-ci-cd" tabindex="-1">什么是 Devops 和 CI/CD <a class="header-anchor" href="#什么是-devops-和-ci-cd" aria-label="Permalink to &quot;什么是 Devops 和 CI/CD&quot;">​</a></h4><p>这里引用 B 站大佬 up 主<a href="https://space.bilibili.com/95256449" target="_blank" rel="noreferrer">遇见狂神说</a>的视频为大家解读，大家可以了解一下整个的应用流程。</p>',4)),s[2]||(s[2]=a("div",{style:{position:"relative","padding-bottom":"56.25%",height:"0"}},[a("iframe",{src:"//player.bilibili.com/player.html?aid=285879510&bvid=BV1zf4y127vu&cid=200860220&page=1&autoplay=0",frameborder:"no",scrolling:"no",style:{position:"absolute",top:"0",left:"0",width:"100%",height:"100%"}})],-1)),s[3]||(s[3]=o(`<h4 id="什么是-github-actions" tabindex="-1">什么是 Github+Actions <a class="header-anchor" href="#什么是-github-actions" aria-label="Permalink to &quot;什么是 Github+Actions&quot;">​</a></h4><p>大家可以查看这篇文章简单了解一下 <a href="https://www.infoq.cn/article/d0mtapbgpbhf3r-cuvf3" target="_blank" rel="noreferrer">所有开源项目免费使用，GitHub 内置 CI/CD 终于来了！</a></p><p>这里附上 Github 官方的介绍文档 <a href="https://docs.github.com/en/actions" target="_blank" rel="noreferrer">GitHub Actions</a></p><h2 id="具体步骤" tabindex="-1">具体步骤 <a class="header-anchor" href="#具体步骤" aria-label="Permalink to &quot;具体步骤&quot;">​</a></h2><p>整体步骤分为两个部分</p><h3 id="将博客部署到-github-page" tabindex="-1">将博客部署到 Github page <a class="header-anchor" href="#将博客部署到-github-page" aria-label="Permalink to &quot;将博客部署到 Github page&quot;">​</a></h3><h4 id="创建-github-page-仓库" tabindex="-1">创建 Github page 仓库 <a class="header-anchor" href="#创建-github-page-仓库" aria-label="Permalink to &quot;创建 Github page 仓库&quot;">​</a></h4><p>首先你需要拥有一个存储渲染文件的博客 repository</p><p>将仓库名命名为 your_username.github.io，这个仓库用来存储 Hexo 渲染的 Html 文件</p><p>具体操作可以参考我之前的两篇文章</p><p>1.<a href="https://blog.sujie-168.top/categories/notes/2020/04/11/My_Blog_Creation_1" target="_blank" rel="noreferrer">我的博客创建之路 1</a></p><p>2.<a href="https://blog.sujie-168.top/categories/notes/2020/04/16/My_Blog_Creation_2" target="_blank" rel="noreferrer">我的博客创建之路 2</a></p><p>也可以参考管家小 e 的<a href="https://mp.weixin.qq.com/mp/homepage?__biz=MzU4NDcxNjQ2Ng==&amp;hid=1&amp;sn=debf3376e6c934da259097b1886297d7&amp;scene=18#wechat_redirect" target="_blank" rel="noreferrer">网站搭建</a>专栏的前三篇来解决</p><h4 id="博客目标效果" tabindex="-1">博客目标效果 <a class="header-anchor" href="#博客目标效果" aria-label="Permalink to &quot;博客目标效果&quot;">​</a></h4><p>打开<code>http://localhost:4000</code>行预览，即可得到与下图相似的结果</p><p><img src="https://d33wubrfki0l68.cloudfront.net/5997a40576f3beca7bbbd86fe79a795e9d520d8e/87f88/themes/screenshots/landscape.png" alt=""></p><h3 id="配置博客文件存储仓库" tabindex="-1">配置博客文件存储仓库 <a class="header-anchor" href="#配置博客文件存储仓库" aria-label="Permalink to &quot;配置博客文件存储仓库&quot;">​</a></h3><h4 id="创建博客仓库" tabindex="-1">创建博客仓库 <a class="header-anchor" href="#创建博客仓库" aria-label="Permalink to &quot;创建博客仓库&quot;">​</a></h4><p>新建博客文章存储的 public 仓库 (公开)</p><p>可以将仓库名命名为 My_Blog，这个仓库将被用来存储你的所有博客文章</p><h4 id="创建-token" tabindex="-1">创建 token <a class="header-anchor" href="#创建-token" aria-label="Permalink to &quot;创建 token&quot;">​</a></h4><p>这一步可以完全根据 github 官方给出的<a href="https://docs.github.com/cn/github/authenticating-to-github/keeping-your-account-and-data-secure/creating-a-personal-access-token" target="_blank" rel="noreferrer">创建个人访问令牌</a>教程操作</p><h4 id="配置密钥-secret" tabindex="-1">配置密钥 secret <a class="header-anchor" href="#配置密钥-secret" aria-label="Permalink to &quot;配置密钥 secret&quot;">​</a></h4><p>将创建好的 Personal Access Token 添加到仓库的 Secrets 中，并设置名称，如下图：</p><p><img src="https://cn-sy1.rains3.com/dfdfgf/blog/How_to_add_HTTPS_to_your_blog/7.jpg" alt=""></p><ul><li>创建 workflow 脚本</li></ul><p>在项目根目录下创建 <code>.github/workflows</code> 文件夹，并在文件夹下创建 YAML 文件用于编写任务执行脚本。</p><p>点击项目下的 Actions</p><p><img src="https://cn-sy1.rains3.com/dfdfgf/blog/How_to_add_HTTPS_to_your_blog/8.jpg" alt=""></p><p>点击 Set up this workflow</p><p><img src="https://cn-sy1.rains3.com/dfdfgf/blog/How_to_add_HTTPS_to_your_blog/9.jpg" alt=""></p><p>配置 main.yml 文件，设置工作流</p><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark-dimmed vp-code-dark"><code><span class="line"><span style="color:#adbac7;">name: Deploy My_Blog  #自动化的名称</span></span>
